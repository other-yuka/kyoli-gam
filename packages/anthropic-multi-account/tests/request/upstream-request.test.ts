...
const DEFAULT_TEMPLATE_CC_VERSION = bundledFingerprintData.cc_version;
...
function createTemplate(overrides?: Partial<TemplateData>): TemplateData {
  return {
    ...
    cc_version: DEFAULT_TEMPLATE_CC_VERSION,
...
describe("upstream-request", () => {
  ...
  test("computeBuildTag matches the billing seed behavior", () => {
    const userMessage = "abcdEfgHiJKLMNOPQRSTUvwx";
    const version = DEFAULT_TEMPLATE_CC_VERSION;
