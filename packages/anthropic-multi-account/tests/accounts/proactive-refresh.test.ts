...
const { AccountStore } = await import("../../src/accounts/store");
...
describe("proactive-refresh", () => {
  beforeEach(async () => {
    ...
    isTokenExpiredMock.mockImplementation((account: Pick<StoredAccount, "accessToken" | "expiresAt">) => isTokenExpiredImpl(account));
  });
