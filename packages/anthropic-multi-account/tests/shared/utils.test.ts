...
const originalConfigModule = await import("../../src/shared/config");
...
afterAll(() => {
  mock.module("../../src/shared/config", () => originalConfigModule);
});

const { formatWaitTime, getAccountLabel, showToast } = await import("../../src/shared/utils");
